...
<h2>Luodaan lomaketta, odota muutama sekunti, ole hyv&auml;!</h2>

<br /><br />

<br /><img src="http://is12.snstatic.fi/kuvat/arska/img-1288394536020.jpeg" alt="arnie" />
<!-- 
<h2>Syötä sähköpostiosoite ja syntymäaika, niin lähetämme sinulle uuden salasanan!</h2>

<form action="save-new-password.php" method="post">

Sähköpostiosoite: <input type="text" name="sposti" maxlength="32" /><br />


Syntymäaika: <select name="paiva" size="1">
...
<br /><br />
<input type="submit" value="Pyydä uusi salasana" name="newpass" />
</form>-->
</body>
</html>