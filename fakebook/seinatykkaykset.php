...
$mysli = "SELECT tykkaysid, seinaviestid, tykkaajaid FROM seinatykkaykset WHERE tykkaajaid = '$kenen' AND tyyppi = 'p';";
...
$fdsf = mysql_num_rows($mysqli);

if($fdsf == 0) {
	echo "<p>Käyttäjä ei ole tykännyt seinäviesteistä!</p>";
}
