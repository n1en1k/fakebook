...
$mysqli= mysql_query($mysli)
	...
	$num_rows = mysql_num_rows($mysqli);
			 	if($num_rows == 0) { 	echo "<h4 style='margin-bottom: 20px;'><a style='padding: 3px; margin-bottom: 20px;' href='littipeukku-y.php?yhteiso=$nayta'>N&auml;yt&auml; yhteisölle Littipeukkua</a>";
				echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style='padding: 3px; margin-bottom: 20px;' href='littirage-y.php?yhteiso=$nayta'>N&auml;yt&auml; yhteisölle Littiragea</a><h4>";
	...
	while ($sllolo = mysql_fetch_array ($mysqli)) {
		 ...
		 if($num_rows == 1) {
		  $tyyppi = $sllolo['tyyppi'];
		 	if($tyyppi == "p") {
						echo "<b>Olet n&auml;ytt&auml;nyt yhteisölle Littipeukkua</b>";
						}
						else {
						echo "<b>Olet n&auml;ytt&auml;nyt yhteisölle Littiragea</b>";
						}
		 }
...
while ($rivi = mysql_fetch_array ($resultt)) {
 $yhteisoid = $rivi['yhteisoid'];
			...
			echo "<h4 style='font-size: 20px; margin: 0;'>Littipeukkua näyttäneet:</h4>";
...
echo "<h4 style='font-size: 20px; margin: 0;'>Littiragea näyttäneet:</h4>";
