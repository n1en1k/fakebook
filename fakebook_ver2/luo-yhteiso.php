...
$title = "The Fakebook - Luo yhteisö-sivu";
 ?>
<?php
...
?>
 ...
 ?>
	...
	<div id="contentwrap">
		<div id="content">
     <form method="post" action="luo-uusi-yhteiso.php">
        Syötä yhteisölle nimi:<br />
<input type="text" size="64" name="yhteisonimi" maxlength="128" /><br /><br />
        Syötä yhteisön kuvaus:<br />
<input type="text" size="100" name="yhteisonkuvaus" maxlength="4096" /><br /><br />

<input type="submit" class="laheta-painike" value="Luo" />
			</form>
		</div>
	</div>
