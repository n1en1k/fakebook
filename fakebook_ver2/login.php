...
require_once('dbopen.php');
   ...
   $sql = "SELECT users.userid, users.sposti, users.password, usertiedot.id, usertiedot.etunimi, usertiedot.sukunimi 
            FROM users, usertiedot 
            WHERE users.sposti = '$sposti' AND users.password = PASSWORD('$passwd')"; 
...
<tr>
	<td><b style="color: #777; font-size: 12px;">Sähköposti:</b></td><td><input class="form-login" type="text" name="sposti" maxlength="36" size="36" /></td>
</tr>
<tr>
